...
public class FragmentLaunchBindingImpl extends FragmentLaunchBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.guglielmoboi.cstimergraph.fragments.launch.LaunchViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.guglielmoboi.cstimergraph.fragments.launch.LaunchViewModel ViewModel) {
